package io.digikraft.photosapp.ui.menu_market.sell.sell_history.adapter
...
class SellHistoryAdapter(private var listener: ItemListener) : BaseAdapter<MarketItem, Int>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): BaseViewHolder<MarketItem, Int> {
        return SellHistoryViewHolder(
